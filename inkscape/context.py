...
class GCodeContext:
    ...
    def start(self,x,y):
      self.codes.append("G1 X%0.2f Y%0.2f Z%0.2f" % (x,y, self.pen_down_angle))
      self.drawing = True

    def stop(self,point):
      self.codes.append("G1 X%0.2f Y%0.2f Z%0.2f" % (point[0],point[1], self.pen_up_angle))
      self.drawing = False
    ...
    def go_to_point(self, x, y, stop=False):
      ...
      if stop:
        ...
        if self.drawing: 
            self.codes.append("G1 X%.2f Y%.2f Z%.2f" % (x,y, self.pen_down_angle))
            self.drawing = False
    ...
    def draw_to_point(self, x, y, stop=False):
      ...
      if stop:
        ...
        if self.drawing == False:
            self.codes.append("G1 X%0.2f Y%0.2f Z%0.2f" % (x,y, self.pen_up_angle))
            self.drawing = True
